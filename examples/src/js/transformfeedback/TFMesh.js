...
import { GL, Object3D } from '../../../../src/index.ts';
...
export default class TFMesh extends Object3D {
  ...
  bindAttributes() {
    ...
    Object.keys(this.geometry.attributes).forEach(attributeName => {
      if (attributeName !== 'aIndex') {
        ...
        this.shaderDraw.program.setAttributeLocation(
          attributeName,
        ...
        // vertexAttribPointer
        this.shaderDraw.program.setAttributePointer(
          attributeName,
          this.geometry.attributes[attributeName].itemSize
        );
      }
  ...
  emit(modelViewMatrix, projectionMatrix, camera) {
    ...
    gl.vertexAttribPointer(
      this.shaderEmit.program.attributeLocations.aPosition,
      3,
      gl.FLOAT,
      false,
      0,
  ...
  draw(modelViewMatrix, projectionMatrix, camera) {
    ...
    gl.bindBuffer(gl.ARRAY_BUFFER, sourceVBO[0]);
    gl.vertexAttribPointer(
      this.shaderDraw.program.attributeLocations.aPosition,
      3,
      gl.FLOAT,
      false,
      0,
