...
var Mesh = function () {
	...
	_createClass(Mesh, [{
		...
		value: function draw(modelViewMatrix, projectionMatrix) {
			...
			if (this.shader.uv) {
				gl.bindBuffer(gl.ARRAY_BUFFER, this.geometry.uvCoordBuffer);
				gl.vertexAttribPointer(this.shader.vertexUvAttribute, this.geometry.uvCoordBuffer.itemSize, gl.FLOAT, false, 0, 0);
			}
			...
			if (this.shader.uniformTextures.length > 0) {
				...
				this.shader.uniformTextures.forEach(function (uniform, i) {
